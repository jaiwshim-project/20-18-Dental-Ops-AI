  <script>
// [moved to DOMContentLoaded] document.getElementById('app').insertAdjacentHTML('afterbegin', renderSidebar('review-tab'));
...
function switchTab(name) {
  ...
  document.querySelectorAll('.consult-layout > .panel').forEach(p => {
